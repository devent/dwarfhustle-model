...
@Data
public class KnowledgeTreeTrunk extends KnowledgeVegetation {

    public static final int OBJECT_TYPE = KnowledgeTreeTrunk.class.getSimpleName().hashCode();
