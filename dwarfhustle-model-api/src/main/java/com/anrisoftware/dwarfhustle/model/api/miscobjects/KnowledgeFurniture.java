...
@Getter
@Setter
public class KnowledgeFurniture extends KnowledgeObjectType {

    public static final String TYPE = "Furniture";

    public static final int OBJECT_TYPE = TYPE.hashCode();

    public KnowledgeFurniture(int kid) {
        super(kid);
    }

    @Override
    public int getObjectType() {
        return KnowledgeFurniture.OBJECT_TYPE;
    }

    @Override
    public String getKnowledgeType() {
        return KnowledgeFurniture.TYPE;
    }
