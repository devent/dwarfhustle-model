 ...
 */
@Slf4j
public class LuceneLoadIndexBenchmark {

    @SneakyThrows
    public static void main(String[] args) {
        Analyzer analyzer = new StandardAnalyzer();

        Path sourcePath = Path.of("/home/devent/Projects/dwarf-hustle/terrain-maps/lucene-index/");
        Path destPath = Files.createTempDirectory("tempIndex");
        FileUtils.copyDirectory(sourcePath.toFile(), destPath.toFile());
        Directory directory = FSDirectory.open(destPath);
