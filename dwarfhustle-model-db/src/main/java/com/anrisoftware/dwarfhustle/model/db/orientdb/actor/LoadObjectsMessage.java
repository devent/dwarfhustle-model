...
public class LoadObjectsMessage<T extends Message> extends DbMessage<T> {
    ...
    public LoadObjectsMessage(ActorRef<T> replyTo, int objectType, Function<ODatabaseDocument, OResultSet> query) {
        this(replyTo, objectType, EMPTY_CONSUMER, query);
    }

    public LoadObjectsMessage(ActorRef<T> replyTo, int objectType, Consumer<StoredObject> consumer,
