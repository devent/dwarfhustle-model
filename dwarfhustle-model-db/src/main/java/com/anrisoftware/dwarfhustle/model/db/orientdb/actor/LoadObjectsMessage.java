 ...
 */
@ToString
public class LoadObjectsMessage<T extends DbMessage<?>> extends DbMessage<T> {

    public static class LoadObjectsSuccessMessage<T extends DbMessage<?>> extends DbSuccessMessage<T> {
    }
